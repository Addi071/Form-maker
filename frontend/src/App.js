...
//   const hideNavbar2 = location.pathname === '/signup';
//   const hideNavbar3 = location.pathname === '/surveys/:id';


//   return (
//     <>
//       {!hideNavbar && !hideNavbar2 && !hideNavbar3 && <Navbar />}
//       <Routes>
...
// //         <Route path="/surveyform" element={ <CreateSurvey></CreateSurvey>} />
// //         <Route path="/create-survey" element={ <CreateSurveyForm></CreateSurveyForm>} />
...
// //         <Route path="/surveys/:id" element={<SurveyAnswerForm />} />
